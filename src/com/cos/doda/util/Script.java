...
public class Script {
	public static void outText(int msg, HttpServletResponse response) {
		try {
	...
	public static void outText2(String msg, HttpServletResponse response) {
		try {
			response.setCharacterEncoding("utf-8");
			response.setContentType("text/plain; charset=utf-8");
			PrintWriter out = response.getWriter();
