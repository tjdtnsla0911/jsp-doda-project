...
<h4>計 <span style="color: blue">${fn:length(dodaKaisha)}件</span>の会社が発見されました</h4>
	...
	<form action="/doda/doda?cmd=sibou" method="post">
<table>
<tr>
<td>
...
<tr>
	...
	<button class="btn btn-primary" width="80" height="40" style="margin-bottom: 3px; float: right;" onclick="saveKaisha()">お気に入り</button>
	<input type="hidden" id="saveKaishas" name="saveKaishas" value="${dodaKaisha.random}">
	<input type="hidden" id="dodauserid" name="dodauserid" value="${prinsipal.id}">
	<input type="hidden" id="kaishaname" name="kaishaname" value="${dodaKaisha.kaishaname}">
